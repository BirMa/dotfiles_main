" Name:		darkbone.vim
" Maintainer:	Kojo Sugita (with some minor changes: search highlight color, nontext color, cursor color)
" Last Change:	2010-11-01 (sometime early 2011)
" Revision:	1.1
...
hi lCursor	guifg=#000000 guibg=#e3d5ff
hi CursorIM	guifg=#000000 guibg=#e3d5ff
...
" Search
" was: hi Search	guifg=#000000 guibg=#c0c0ff gui=none
hi Search       guifg=#000000 guibg=#9a9acd gui=none
hi IncSearch	guifg=#000000 guibg=#ca9acd gui=none
